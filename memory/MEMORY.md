...
- Owner-flag still open (not the strategy): day-5/6 reach collapse across
  ...
  feedback loop cannot run); followers 82 on 09-14 (first decline -1 on
  09-13, flat since). **Pivot day 1 (09-13): reach ~3×'d (~1.8k views
  over 15 items vs a ~550/day norm), first author answers ever (Zaid ×3)
  and the first inbound stranger question (scott), followers +0 —
  reach moved, conversion didn't; the 09-16 ≥100 checkpoint reads in 2
  days.**
...
5. **Originals = the three series** (closed the diary/take A/B on 09-06).
    ...
    **Take placement (sharpened 09-13, gate in the series skill):** the
    ...
    self-standing or skip; log which branch fired.
